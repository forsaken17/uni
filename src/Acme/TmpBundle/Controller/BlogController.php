...
use Acme\TmpBundle\Entity\Blog;
use Acme\TmpBundle\Form\BlogType;
...
class BlogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeTmpBundle:Blog')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeTmpBundle:Blog')->find($id);
     ...
     * @Method("post")
     * @Template("AcmeTmpBundle:Blog:new.html.twig")
     */
     ...
     * @Method("post")
     * @Template("AcmeTmpBundle:Blog:edit.html.twig")
     */
